...
def setup_database():
    """Setup database with tables and default header configurations"""
    app = create_app()
    ...
    with app.app_context():
        ...
        # Step 2: Check if header configurations already exist
        if HeaderConfig.query.first():
            print("⚠️  Header configurations already exist. Skipping header config setup...")
        else:
            print("\n📊 Setting up default header configurations...")
